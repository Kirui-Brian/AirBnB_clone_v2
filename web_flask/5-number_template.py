#!/usr/bin/python3
"""
This odule contains a Flask instance.
...
def python_text(text):
    """
    This function returns the string "Python" followed by the value of the text variable when accessing the '/pythin/<text>' path.
    Underscore symbols in the text variable are replaced with a space.
...
def number_n(n):
    """
    This function returns the string "n is a number" wehn accessing the '/number/<n>' path.
